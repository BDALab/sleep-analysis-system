...
# ------------------------------
model_params = configure_xgboost_params({
    # General parameters
    "booster": "gbtree",
    "verbosity": 1,
    ...
    # Runtime device, tree method, and thread count are set centrally.
    "max_bin": 512,
    "subsample": 0.8,
...
search_settings = {
    ...
    # Keep outer search serial; each XGBoost fit uses bounded native threads.
    "n_jobs": 1,
    "n_iter": 100,
    "verbose": 1
}
